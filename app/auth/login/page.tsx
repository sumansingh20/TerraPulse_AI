          ...
          <CardContent className="p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                variant="outline"
                onClick={() => {
                  setLoginData({email: "demo@farmer.com", password: "demo123", role: "farmer"})
                }}
              ...
              <Button
                variant="outline"
                onClick={() => {
                  setLoginData({email: "demo@company.com", password: "demo123", role: "company"})
                }}
                className="glass bg-transparent"
              >
              ...
              <Button
                variant="outline"
                onClick={() => {
                  setLoginData({email: "demo@admin.com", password: "demo123", role: "admin"})
                }}
                className="glass bg-transparent"
              >
                <Shield className="mr-2 h-4 w-4" />
