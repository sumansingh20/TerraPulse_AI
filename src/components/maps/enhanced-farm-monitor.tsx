  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        {/* Enhanced Regional Data & Satellite Features */}
        <div className="space-y-6">
          {/* Regional Overview */}
          <Card className={`${enableGlassMorphism ? 'glass' : 'bg-card'} border-primary/30`}>
            <CardHeader>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <span>{region.credits.toLocaleString()} credits</span>
                    </div>
                    <div className="flex items-center gap-2 text-muted-foreground">
                      {region.alerts > 0 ? (
                  ...
                  <div className="mt-3">
                    ...
                    <Progress value={85 + region.farms / 50} className="h-2" />
                  </div>
                </div>
              ))}
            </CardContent>
          ...
          {/* Satellite Analysis Features */}
          <Card className={`${enableGlassMorphism ? 'glass' : 'bg-card'} border-accent/30`}>
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
              ...
              {satelliteFeatures.map((feature, index) => (
                <div key={index} className="p-3 bg-accent/5 rounded-lg border border-accent/20">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-xs font-medium">{feature.accuracy}%</div>
                  </div>
                </div>
              ))}
            </CardContent>
          ...
          <Card className={`${enableGlassMorphism ? 'glass' : 'bg-card'} border-orange-500/30`}>
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
            ...
            <CardContent className="space-y-3">
              <div className="p-3 bg-green-500/5 rounded-lg border border-green-500/20">
                <div className="flex items-center gap-2 mb-1">
                  <CheckCircle2 className="h-4 w-4 text-green-500" />
                  <div className="text-sm font-medium text-foreground">Optimal Growth Conditions</div>
                </div>
                <div className="text-xs text-muted-foreground">
                  Next 7 days show excellent conditions for carbon sequestration
                </div>
              </div>
              ...
              <div className="p-3 bg-blue-500/5 rounded-lg border border-blue-500/20">
                ...
                <div className="text-xs text-muted-foreground">
                  Nitrogen levels increasing by 3.2% in Maharashtra Zone A
                </div>
              </div>
              ...
              <div className="p-3 bg-orange-500/5 rounded-lg border border-orange-500/20">
                ...
                <div className="text-xs text-muted-foreground">
                  Irrigation optimization recommended for 12 farms
                </div>
              </div>
            </CardContent>
          </Card>
